...
const Cradpayment = () => {
  return (
    <>
      <div className="container main-pay">
        <div className="row">
          ...
          <div className="col-12 my-3">
            <div className="card p-3">
                  ...
                  <div className="row">
                    <div className="col-8 my-3">
                      ...
                      <p className="mb-0">
                        ...
                        <span className="c-green">: User Name</span>
                      </p>
                      <p className="mb-0">
              ...
              <div className="card-body border p-0 my-2">
                <p>
                  <a
                ...
                <div
                  className="collapse show p-3 pt-0 my-3"
                  id="collapseExample"
                >
                  <div className="row">
